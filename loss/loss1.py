...
class PredLoss(nn.Module):
    ...
    def forward(self, out: Dict[str, List[Tensor]], 
        ...
        max_last, last_idcs = last.max(1)                                                # last_idcs indicates that whether the last frame is available
        mask = max_last > 1.0                                                            # max_last indicates whether the ob has at least one valid frame
