...
from models.base_modules.linear import Conv1d, Linear, Res1d
...
class ActorNet(nn.Module):
    ...
    def __init__(self, config):
        ...
        for i in range(len(num_blocks)):
            ...
            if i == 0:
                ...
                group.append(
                    blocks[i](n_in, n_out[i], stride=2, norm=norm, ng=ng)
                )
    ...
    def forward(self, actors):
        ...
        for i in range(len(outputs) - 2, -1, -1):
            out = F.interpolate(
                out, scale_factor=2, mode="linear", align_corners=False
            )
